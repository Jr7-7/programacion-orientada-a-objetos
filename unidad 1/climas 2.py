...
def calcular_promedio (divisor, dividendo):
   return round(divisor / dividendo, 2)

# Calcular el promedio de temperaturas para cada ciudad y semana
no_ciudad = 0
for ciudad in temperaturas:
    no_ciudad = no_ciudad + 1
    print(f'EL PROMEDIO DE LA CIUDAD N°. {no_ciudad}')
    no_semana = 0
    suma_promedio = 0
    for semana in ciudad:
        ...
        print(f' el promedio de la semana N°. {no_semana} es: {promedio }')

        promedio_ciudad = calcular_promedio(suma, len(ciudad))
